...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--port', type=int, default=7545,
    ...
    with open('contract_address.json') as f:
        ...
        abi = contract_data["Fogchain"]['abi']

        contract_address = contract_data["Fogchain"]['address']
        Fogchain = node.eth.contract(address=contract_address, abi=abi)
